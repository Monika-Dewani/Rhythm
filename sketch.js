...
function preload(){
  ...
  h1=loadImage("my1.gif");
   ...
   h6=loadImage("flower_5.png");
   h7=loadImage("flower3.png");
   h8=loadImage("flower4.png");
   h9=loadImage("flower6.png");
   h10=loadImage("flower8.png");
   
   h11=loadImage("flower7.png");
...
//     ghost.velocityY = ghost.velocityY + 0.8
   ...
   // spawnDoors();
    ...
    text("Happy Birthday Rhythm",ghost.x-390,ghost.y+15);
    // imageMode(CENTER);
    // image(h10,ghost.x-100,ghost.y-60,100,50)
...
{
  if(frameCount%10===0){
    var heart = createSprite(Math.round(random(0,width)), Math.round(random(0,height+200)));
   ...
   switch (rand){
       ...
       case 10:heart.addImage(h10);
       heart.scale=0.2
       break; 

       case 5:heart.addImage(h6);
       heart.scale=0.1
       break; 

       case 6:heart.addImage(h7);
       heart.scale=0.2
       break; 

       case 7:heart.addImage(h8);
       heart.scale=0.2
       break; 

       case 8:heart.addImage(h9);
       heart.scale=0.2
       break; 

       case 9:heart.addImage(h11);
       heart.scale=0.05
       break; 
  }
